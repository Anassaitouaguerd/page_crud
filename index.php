                    ...
                    <div class="container-fluid pe-0">
                        ...
                        <div class="collapse navbar-collapse" id="navigation">
                            <ul class="navbar-nav mx-auto ms-xl-auto me-xl-7">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link me-2" href="./pages/page_sign-up.php">
                    ...
                    <div class="row">
                        <div class="col-xl-4 col-lg-5 col-md-6 d-flex flex-column mx-auto">
                            <div class="card card-plain mt-8">
                                ...
                                <div class="card-body">
                                    <form role="form" method="POST" action="./pages/login.php">
                                        <label>Email</label>
                                        <div class="mb-3">
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-8 mx-auto text-center mb-4 mt-2">
                    ...
                    <a href="https://github.com/Anassaitouaguerd" target="_blank" class="text-secondary me-xl-4 me-4">
