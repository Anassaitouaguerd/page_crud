            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="../pages/tables.php">
                        ...
                        <span class="nav-link-text ms-1">Table_users</span>
                    </a>
                </li>
                <li class="nav-item">
                            ...
                            <div class="row">
                                <div class="col-8">
                                    <div class="numbers">
                                        ...
                                        $sql_count_CT = "SELECT COUNT(*) AS total_category
                                        FROM category";
                                        $result_count_CT = mysqli_query($conn,$sql_count_CT);
                                        $row_category = $result_count_CT -> fetch_assoc();

                                        ?>

                                        <h5 class="font-weight-bolder mb-0">
                                            <?php echo $row_category['total_category']; ?>
                            ...
                            <div class="row">
                                <div class="col-8">
                                    <div class="numbers">
                                        ...
                                        $row_users = $result_count -> fetch_assoc();

                                        ?>
                                        <h5 class="font-weight-bolder mb-0">
                                            <?php echo $row_users['total_users']; ?>
                                            <span class="ext-secondary text-sm font-weight-bolder"> User </span>
                                        </h5>
                                    </div>
                                </div>
                                <div class="col-4 text-end">
                            ...
                            <div class="row">
                                <div class="col-8">
                                    <div class="numbers">
                                        ...
                                        $sql_count_RC = "SELECT COUNT(*) AS total_ressource
                                        FROM ressource";
                                        $result_count_RC = mysqli_query($conn,$sql_count_RC);
                                        $row_RC = $result_count_RC -> fetch_assoc();

                                        ?>
                                        <h5 class="font-weight-bolder mb-0">
                                            <?php echo $row_RC['total_ressource']; ?>
                                            <span class="text-danger text-sm font-weight-bolder">ressources</span>
                                        </h5>
                                    </div>
                                </div>
                                <div class="col-4 text-end">
                            ...
                            <div class="row">
                                <div class="col-8">
                                    <div class="numbers">
                                        ...
                                        $sql_count_SC = "SELECT COUNT(*) AS total_SC
                                        FROM subcategory";
                                        $result_count_SC = mysqli_query($conn,$sql_count_SC);
                                        $row_SC = $result_count_SC -> fetch_assoc();

                                        ?>
                                        <h5 class="font-weight-bolder mb-0">
                                            <?php echo $row_SC['total_SC']; ?>
                                            <span class="text-warning text-sm font-weight-bolder">Sub _ category</span>
                                        </h5>
                                    </div>
                                </div>
                                <div class="col-4 text-end">
